...
#Second Paragraph: (needs to build off a main point from the intro and needs to have a strong lead sentence) (this is kind of dependent on weather or not we try and standardize soil sampling methods...)
...
__*intro sentence*__ :Understanding how microbial communities change with forest succession stage can allow us to infer how the forest ecosystem will respond. Both @Yan_2020 and @Zhou_2017 have shown that as forest systems transition into later successional stages we see a shift from a bacterial dominated system into a soil ecosystem that is highly dominated by fungi. Additionally, @Jiang_2021 has shown that the relative abundance certain fungal communities significantly increase with succession. Conversely, it was noted that bacterial groups remained relatively unchanged. This suggests that either fungi are more involved in nutrient cycling as forest ages increase, or that bacteria are able to maintain functionality in different soil conditions. 


#Fourth Paragraph: (need more literature review)

__*intro sentence*__ : While it may not be clear as to how microbial communities change as forest stages progress, it is very apparent that disturbance directly impacts microbial communities. 
...
# @Wang_2021: Secondary succession and fungal/bacterial community composition (karst area)
...
# ****  @Jiang_2021: Bacterial and *Fungal* community composition and functional changes with forest succession:
  ...
  #  - *** The relative abundance of ectomycorrhizal fungi significantly increased with succession, while the relative abundance of bacterial functional rgoups involved in the nitrogen cycle did not change significantly, indicating that fungi might play a major regulatory role in the nutrient cycling process during the successional process.

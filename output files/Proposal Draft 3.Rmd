...
Current unknowns and controversies in the literature (Ex: @Luyssaert_2008 --> @Gundersen_2021 --> @Luyssaert_2021) regarding old growth forests demands a more collective understanding of the function and fate of these systems. We believe it is the misrepresentation of the below ground community significantly contributing to not only such contrasting findings, but also to the lack of clarity in soil science and soil ecosystem functionality as a whole. 

The general aim of this study is to analyze soil systems in terms of carbon functionality as successional stages (SS) progress. We want to see, given different levels of disturbance, if soil carbon functionality changes with time and community composition. To do this we have selected old growth forests as our study system due to the few avaliable areas with remaining longevity, and fungi as our model organism as they are the stewards of soil carbon dynamics. In order to achieve our aims, the study will be broken down into three parts: Part 1 consists of a proof of concept expirement that will allow us to determine the impact of analyzing a fungal community through three different genome analysis methods. We will test the capability of amplicon sequencing, whole genome sequencing, and whole transcriptome sequencing in analyzing fungal communities among three different sub-expirements. These expirements will test the infleunce of carbon-substrate type, soil type, and the level of microbial interferene on the ability of these methods to accurately represent the given community. These tests will be conducted on a known community consisting of 9 different saprotrophic fungi, containing (3) early, (3) middle, and (3) late succesional stage species. The results from Part 1 will dictate the methods used to analyze fungal communities in the field. Part 2 will involve soil sampling and physiolgoical measurements in attempts to capture any mechanisms or parameters associated with changes in fungal community. Part 3 will involve a greenhouse expirement taking soil samples from different SS's and testing
carbon attributes such as enzymatic production, respiration rates (flux), and fractionating of carbon pools. This will allow us to further analyze functional differences among soils from varrying SS's. Pending the results from Parts 1-3, we hope to repeat each part for both boreal and hardwood old growth forest systems. The overall gap this research aims to fill is wheather or not there are distinct soil functional differences based on carbon mechanisms provided by fungal community in forest succession. Providing insight to this question will provide a number of opprotunities for future resaerch. For one, it appears to be the first attempt in specfically determining if there is functional differences among old growth soils. While we are only analyzing carbon and fungal communities, if trends arise it opens a massive area of research in learning how soils differ functionally among different microbial communities along successional gradients. Alternively, if no trends are observed and the null hypothesis is supported, it can provide reason for future resarchers to save massive amouunts of time and money on genomic analysis. Contraily, given trends do arise, it provokes the need for further understanding as to how specific fungal communities provide different levels of functionality. These old growth ecosystems are natures natural responders to distrubances such as climate change. If they are able to adapt and respond to such changes, we can learn from them as they may provide answeres to how we can move foward and look towards natural approaches to save our ever fleeting fertile soils.
